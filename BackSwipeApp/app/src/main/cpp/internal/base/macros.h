...
// Reference:
// https://github.com/google/google-api-cpp-client/blob/master/src/googleapis/base/macros.h
...
// the internal.base::LINKER_INITIALIZED argument.  Normally, it is unsafe to declare a
...
//       explicit MyClass(internal.base::LinkerInitialized x) {}
// and invoked as
//       static MyClass my_variable_name(internal.base::LINKER_INITIALIZED);
namespace base {
